...
namespace STranslate.Style.Controls
{
    ...
    public partial class MessageBox_S : Window
    {
        ...
        {
            bool? result = null;
            MessageBox_S messageBox = new MessageBox_S(msg);
        ...
        {
            bool? result = false;
            MessageBox_S messageBox = new MessageBox_S(msg, caption);
        ...
        public static MessageBoxResult Show(string msg, string caption, MessageBoxButton messageBoxButton)
        {
            ...
            MessageBox_S messageBox = new MessageBox_S(msg, caption, messageBoxButton);
