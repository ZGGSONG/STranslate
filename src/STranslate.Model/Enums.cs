...
{
    [Description("Xiaotong(晓彤)-中文（吴语，简体）")] wuu_CN_XiaotongNeural,
    [Description("Yunzhe(云哲)-中文（吴语，简体）")] wuu_CN_YunzheNeural,
    [Description("XiaoMin(晓敏)-中文（粤语，简体）")] yue_CN_XiaoMinNeural,
    [Description("YunSong(云松)-中文（粤语，简体）")] yue_CN_YunSongNeural,
    [Description("Xiaoxiao(晓晓)-中文（普通话，简体）")] zh_CN_XiaoxiaoNeural,
    [Description("Yunxi(云希)-中文（普通话，简体）")] zh_CN_YunxiNeural,
    [Description("Yunjian(云健)-中文（普通话，简体）")] zh_CN_YunjianNeural,
    [Description("Xiaoyi(晓伊)-中文（普通话，简体）")] zh_CN_XiaoyiNeural,
    [Description("Yunyang(云扬)-中文（普通话，简体）")] zh_CN_YunyangNeural,
    [Description("Xiaochen(晓辰)-中文（普通话，简体）")] zh_CN_XiaochenNeural,
    [Description("Xiaochen Multilingual(晓辰 多语言)-中文（普通话，简体）")] zh_CN_XiaochenMultilingualNeural,
    [Description("Xiaohan(晓涵)-中文（普通话，简体）")] zh_CN_XiaohanNeural,
    [Description("Xiaomeng(晓梦)-中文（普通话，简体）")] zh_CN_XiaomengNeural,
    [Description("Xiaomo(晓墨)-中文（普通话，简体）")] zh_CN_XiaomoNeural,
    [Description("Xiaoqiu(晓秋)-中文（普通话，简体）")] zh_CN_XiaoqiuNeural,
    [Description("Xiaorou(晓柔)-中文（普通话，简体）")] zh_CN_XiaorouNeural,
    [Description("Xiaorui(晓睿)-中文（普通话，简体）")] zh_CN_XiaoruiNeural,
    [Description("Xiaoshuang(晓双)-中文（普通话，简体）")] zh_CN_XiaoshuangNeural,
    [Description("Xiaoxiao Dialects(晓晓 方言)-中文（普通话，简体）")] zh_CN_XiaoxiaoDialectsNeural,
    [Description("Xiaoxiao Multilingual(晓晓 多语言)-中文（普通话，简体）")] zh_CN_XiaoxiaoMultilingualNeural,
    [Description("Xiaoyan(晓颜)-中文（普通话，简体）")] zh_CN_XiaoyanNeural,
    [Description("Xiaoyou(晓悠)-中文（普通话，简体）")] zh_CN_XiaoyouNeural,
    [Description("Xiaoyu Multilingual(晓宇 多语言)-中文（普通话，简体）")] zh_CN_XiaoyuMultilingualNeural,
    [Description("Xiaozhen(晓甄)-中文（普通话，简体）")] zh_CN_XiaozhenNeural,
    [Description("Yunfeng(云枫)-中文（普通话，简体）")] zh_CN_YunfengNeural,
    [Description("Yunhao(云皓)-中文（普通话，简体）")] zh_CN_YunhaoNeural,
    [Description("Yunjie(云杰)-中文（普通话，简体）")] zh_CN_YunjieNeural,
    [Description("Yunxia(云夏)-中文（普通话，简体）")] zh_CN_YunxiaNeural,
    [Description("Yunye(云野)-中文（普通话，简体）")] zh_CN_YunyeNeural,
    [Description("Yunyi Multilingual(云逸 多语言)-中文（普通话，简体）")] zh_CN_YunyiMultilingualNeural,
    [Description("Yunze(云泽)-中文（普通话，简体）")] zh_CN_YunzeNeural,
    [Description("Yunfan Multilingual(Yunfan Multilingual)-中文（普通话，简体）")] zh_CN_YunfanMultilingualNeural,
    [Description("Yunxiao Multilingual(Yunxiao Multilingual)-中文（普通话，简体）")] zh_CN_YunxiaoMultilingualNeural,
    [Description("Yunqi(云奇 广西)-中文（广西方言，简体）")] zh_CN_guangxi_YunqiNeural,
    [Description("Yundeng(云登)-中文（中原官话，河南，简体）")] zh_CN_henan_YundengNeural,
    [Description("Xiaobei(晓北 辽宁)-中文（东北官话，简体）")] zh_CN_liaoning_XiaobeiNeural,
    [Description("Yunbiao(云彪 辽宁)-中文（东北官话，简体）")] zh_CN_liaoning_YunbiaoNeural,
    [Description("Xiaoni(晓妮)-中文（中原官话，陕西，简体）")] zh_CN_shaanxi_XiaoniNeural,
    [Description("Yunxiang(云翔)-中文（吉鲁官话，简体）")] zh_CN_shandong_YunxiangNeural,
    [Description("Yunxi(云希 四川)-中文（西南官话，简体）")] zh_CN_sichuan_YunxiNeural,
    [Description("HiuMaan(曉曼)-中文（粤语，繁体）")] zh_HK_HiuMaanNeural,
    [Description("WanLung(雲龍)-中文（粤语，繁体）")] zh_HK_WanLungNeural,
    [Description("HiuGaai(曉佳)-中文（粤语，繁体）")] zh_HK_HiuGaaiNeural,
    [Description("HsiaoChen(曉臻)-中文（台湾官话，繁体）")] zh_TW_HsiaoChenNeural,
    [Description("YunJhe(雲哲)-中文（台湾官话，繁体）")] zh_TW_YunJheNeural,
    [Description("HsiaoYu(曉雨)-中文（台湾官话，繁体）")] zh_TW_HsiaoYuNeural,
    ...
    [Description("Sun-Hi(선히)-韩语（韩国）")] ko_KR_SunHiNeural,
    [Description("InJoon(인준)-韩语（韩国）")] ko_KR_InJoonNeural,
    [Description("BongJin(봉진)-韩语（韩国）")] ko_KR_BongJinNeural,
    [Description("GookMin(국민)-韩语（韩国）")] ko_KR_GookMinNeural,
    [Description("Hyunsu(현수)-韩语（韩国）")] ko_KR_HyunsuNeural,
    [Description("JiMin(지민)-韩语（韩国）")] ko_KR_JiMinNeural,
    [Description("SeoHyeon(서현)-韩语（韩国）")] ko_KR_SeoHyeonNeural,
    [Description("SoonBok(순복)-韩语（韩国）")] ko_KR_SoonBokNeural,
    [Description("YuJin(유진)-韩语（韩国）")] ko_KR_YuJinNeural,
    [Description("Hyunsu Multilingual(Hyunsu Multilingual)-韩语（韩国）")] ko_KR_HyunsuMultilingualNeural,
    [Description("Nanami(七海)-日语（日本）")] ja_JP_NanamiNeural,
    [Description("Keita(圭太)-日语（日本）")] ja_JP_KeitaNeural,
    [Description("Aoi(碧衣)-日语（日本）")] ja_JP_AoiNeural,
    [Description("Daichi(大智)-日语（日本）")] ja_JP_DaichiNeural,
    [Description("Mayu(真夕)-日语（日本）")] ja_JP_MayuNeural,
    [Description("Naoki(直紀)-日语（日本）")] ja_JP_NaokiNeural,
    [Description("Shiori(志織)-日语（日本）")] ja_JP_ShioriNeural,
    [Description("Svetlana(Светлана)-俄语（俄罗斯）")] ru_RU_SvetlanaNeural,
    [Description("Dmitry(Дмитрий)-俄语（俄罗斯）")] ru_RU_DmitryNeural,
    [Description("Dariya(Дария)-俄语（俄罗斯）")] ru_RU_DariyaNeural,
    [Description("Adri(Adri)-南非语（南非）")] af_ZA_AdriNeural,
    [Description("Willem(Willem)-南非语（南非）")] af_ZA_WillemNeural,
    [Description("Mekdes(መቅደስ)-阿姆哈拉语（埃塞俄比亚）")] am_ET_MekdesNeural,
    [Description("Ameha(አምሀ)-阿姆哈拉语（埃塞俄比亚）")] am_ET_AmehaNeural,
    [Description("Fatima(فاطمة)-阿拉伯语（阿拉伯联合酋长国）")] ar_AE_FatimaNeural,
    [Description("Hamdan(حمدان)-阿拉伯语（阿拉伯联合酋长国）")] ar_AE_HamdanNeural,
    [Description("Laila(ليلى)-阿拉伯语（巴林）")] ar_BH_LailaNeural,
    [Description("Ali(علي)-阿拉伯语（巴林）")] ar_BH_AliNeural,
    [Description("Amina(أمينة)-阿拉伯语（阿尔及利亚）")] ar_DZ_AminaNeural,
    [Description("Ismael(إسماعيل)-阿拉伯语（阿尔及利亚）")] ar_DZ_IsmaelNeural,
    [Description("Salma(سلمى)-阿拉伯语（埃及）")] ar_EG_SalmaNeural,
    [Description("Shakir(شاكر)-阿拉伯语（埃及）")] ar_EG_ShakirNeural,
    [Description("Rana(رنا)-阿拉伯语（伊拉克）")] ar_IQ_RanaNeural,
    [Description("Bassel(باسل)-阿拉伯语（伊拉克）")] ar_IQ_BasselNeural,
    [Description("Sana(سناء)-阿拉伯语（约旦）")] ar_JO_SanaNeural,
    [Description("Taim(تيم)-阿拉伯语（约旦）")] ar_JO_TaimNeural,
    [Description("Noura(نورا)-阿拉伯语（科威特）")] ar_KW_NouraNeural,
    [Description("Fahed(فهد)-阿拉伯语（科威特）")] ar_KW_FahedNeural,
    [Description("Layla(ليلى)-阿拉伯语（黎巴嫩）")] ar_LB_LaylaNeural,
    [Description("Rami(رامي)-阿拉伯语（黎巴嫩）")] ar_LB_RamiNeural,
    [Description("Iman(إيمان)-阿拉伯语（利比亚）")] ar_LY_ImanNeural,
    [Description("Omar(أحمد)-阿拉伯语（利比亚）")] ar_LY_OmarNeural,
    [Description("Mouna(منى)-阿拉伯语（摩洛哥）")] ar_MA_MounaNeural,
    [Description("Jamal(جمال)-阿拉伯语（摩洛哥）")] ar_MA_JamalNeural,
    [Description("Aysha(عائشة)-阿拉伯语（阿曼）")] ar_OM_AyshaNeural,
    [Description("Abdullah(عبدالله)-阿拉伯语（阿曼）")] ar_OM_AbdullahNeural,
    [Description("Amal(أمل)-阿拉伯语（卡塔尔）")] ar_QA_AmalNeural,
    [Description("Moaz(معاذ)-阿拉伯语（卡塔尔）")] ar_QA_MoazNeural,
    [Description("Zariyah(زارية)-阿拉伯语（沙特阿拉伯）")] ar_SA_ZariyahNeural,
    [Description("Hamed(حامد)-阿拉伯语（沙特阿拉伯）")] ar_SA_HamedNeural,
    [Description("Amany(أماني)-阿拉伯语（叙利亚）")] ar_SY_AmanyNeural,
    [Description("Laith(ليث)-阿拉伯语（叙利亚）")] ar_SY_LaithNeural,
    [Description("Reem(ريم)-阿拉伯语（突尼斯）")] ar_TN_ReemNeural,
    [Description("Hedi(هادي)-阿拉伯语（突尼斯）")] ar_TN_HediNeural,
    [Description("Maryam(مريم)-阿拉伯语（也门）")] ar_YE_MaryamNeural,
    [Description("Saleh(صالح)-阿拉伯语（也门）")] ar_YE_SalehNeural,
    [Description("Priyom(প্ৰিয়ম)-阿萨姆语（印度）")] as_IN_PriyomNeural,
    [Description("Yashica(যাশিকা)-阿萨姆语（印度）")] as_IN_YashicaNeural,
    [Description("Banu(Banu)-阿塞拜疆语（拉丁语，阿塞拜疆）")] az_AZ_BanuNeural,
    [Description("Babek(Babək)-阿塞拜疆语（拉丁语，阿塞拜疆）")] az_AZ_BabekNeural,
    [Description("Kalina(Калина)-保加利亚语（保加利亚）")] bg_BG_KalinaNeural,
    [Description("Borislav(Борислав)-保加利亚语（保加利亚）")] bg_BG_BorislavNeural,
    [Description("Nabanita(নবনীতা)-孟加拉语（孟加拉国）")] bn_BD_NabanitaNeural,
    [Description("Pradeep(প্রদ্বীপ)-孟加拉语（孟加拉国）")] bn_BD_PradeepNeural,
    [Description("Tanishaa(তানিশা)-孟加拉语（印度）")] bn_IN_TanishaaNeural,
    [Description("Bashkar(ভাস্কর)-孟加拉语（印度）")] bn_IN_BashkarNeural,
    ...
    [Description("Antonin(Antonín)-捷克语（捷克语）")] cs_CZ_AntoninNeural,
    ...
    [Description("Florian Multilingual(Florian Mehrsprachig)-德语（德国）")] de_DE_FlorianMultilingualNeural,
    ...
    [Description("Seraphina Multilingual(Seraphina Mehrsprachig)-德语（德国）")] de_DE_SeraphinaMultilingualNeural,
    [Description("Tanja(Tanja)-德语（德国）")] de_DE_TanjaNeural,
    [Description("Athina(Αθηνά)-希腊语（希腊）")] el_GR_AthinaNeural,
    [Description("Nestoras(Νέστορας)-希腊语（希腊）")] el_GR_NestorasNeural,
    ...
    [Description("Maria(María)-西班牙语（哥斯达黎加）")] es_CR_MariaNeural,
    ...
    [Description("Alvaro(Álvaro)-西班牙语（西班牙）")] es_ES_AlvaroNeural,
    ...
    [Description("Andres(Andrés)-西班牙语（危地马拉）")] es_GT_AndresNeural,
    ...
    [Description("Victor(Víctor)-西班牙语（波多黎各）")] es_PR_VictorNeural,
    ...
    [Description("Sebastian(Sebastián)-西班牙语（委内瑞拉）")] es_VE_SebastianNeural,
    ...
    [Description("Dilara(دلارا)-波斯语（伊朗）")] fa_IR_DilaraNeural,
    [Description("Farid(فرید)-波斯语（伊朗）")] fa_IR_FaridNeural,
    ...
    [Description("Remy Multilingual(Rémy Multilingue)-法语（法国）")] fr_FR_RemyMultilingualNeural,
    [Description("Vivienne Multilingual(Vivienne Multilingue)-法语（法国）")] fr_FR_VivienneMultilingualNeural,
    ...
    [Description("Dhwani(ધ્વની)-古吉拉特语（印度）")] gu_IN_DhwaniNeural,
    [Description("Niranjan(નિરંજન)-古吉拉特语（印度）")] gu_IN_NiranjanNeural,
    [Description("Hila(הילה)-希伯来语（以色列）")] he_IL_HilaNeural,
    [Description("Avri(אברי)-希伯来语（以色列）")] he_IL_AvriNeural,
    [Description("Swara(स्वरा)-印地语（印度）")] hi_IN_SwaraNeural,
    [Description("Madhur(मधुर)-印地语（印度）")] hi_IN_MadhurNeural,
    [Description("Aarav(आरव )-印地语（印度）")] hi_IN_AaravNeural,
    [Description("Ananya(अनन्या)-印地语（印度）")] hi_IN_AnanyaNeural,
    [Description("Kavya(काव्या)-印地语（印度）")] hi_IN_KavyaNeural,
    [Description("Kunal(कुनाल )-印地语（印度）")] hi_IN_KunalNeural,
    [Description("Rehaan(रेहान)-印地语（印度）")] hi_IN_RehaanNeural,
    [Description("Gabrijela(Gabrijela)-克罗地亚语（克罗地亚）")] hr_HR_GabrijelaNeural,
    [Description("Srecko(Srećko)-克罗地亚语（克罗地亚）")] hr_HR_SreckoNeural,
    [Description("Noemi(Noémi)-匈牙利语（匈牙利）")] hu_HU_NoemiNeural,
    [Description("Tamas(Tamás)-匈牙利语（匈牙利）")] hu_HU_TamasNeural,
    [Description("Anahit(Անահիտ)-亚美尼亚语（亚美尼亚）")] hy_AM_AnahitNeural,
    [Description("Hayk(Հայկ)-亚美尼亚语（亚美尼亚）")] hy_AM_HaykNeural,
    [Description("Gadis(Gadis)-印度尼西亚语（印度尼西亚）")] id_ID_GadisNeural,
    [Description("Ardi(Ardi)-印度尼西亚语（印度尼西亚）")] id_ID_ArdiNeural,
    [Description("Gudrun(Guðrún)-冰岛语（冰岛）")] is_IS_GudrunNeural,
    ...
    [Description("Masaru Multilingual(勝 多言語)-日语（日本）")] ja_JP_MasaruMultilingualNeural,
    [Description("Siti(Siti)-爪哇语（拉丁语，印度尼西亚）")] jv_ID_SitiNeural,
    [Description("Dimas(Dimas)-爪哇语（拉丁语，印度尼西亚）")] jv_ID_DimasNeural,
    [Description("Eka(ეკა)-格鲁吉亚语（格鲁吉亚）")] ka_GE_EkaNeural,
    [Description("Giorgi(გიორგი)-格鲁吉亚语（格鲁吉亚）")] ka_GE_GiorgiNeural,
    [Description("Aigul(Айгүл)-哈萨克语（哈萨克斯坦）")] kk_KZ_AigulNeural,
    [Description("Daulet(Дәулет)-哈萨克语（哈萨克斯坦）")] kk_KZ_DauletNeural,
    [Description("Sreymom(ស្រីមុំ)-高棉语（柬埔寨）")] km_KH_SreymomNeural,
    [Description("Piseth(ពិសិដ្ឋ)-高棉语（柬埔寨）")] km_KH_PisethNeural,
    [Description("Sapna(ಸಪ್ನಾ)-卡纳达语（印度）")] kn_IN_SapnaNeural,
    [Description("Gagan(ಗಗನ್)-卡纳达语（印度）")] kn_IN_GaganNeural,
    [Description("Keomany(ແກ້ວມະນີ)-老挝语（老挝）")] lo_LA_KeomanyNeural,
    [Description("Chanthavong(ຈັນທະວົງ)-老挝语（老挝）")] lo_LA_ChanthavongNeural,
    ...
    [Description("Marija(Марија)-马其顿语（北马其顿）")] mk_MK_MarijaNeural,
    [Description("Aleksandar(Александар)-马其顿语（北马其顿）")] mk_MK_AleksandarNeural,
    [Description("Sobhana(ശോഭന)-马拉雅拉姆语（印度）")] ml_IN_SobhanaNeural,
    [Description("Midhun(മിഥുൻ)-马拉雅拉姆语（印度）")] ml_IN_MidhunNeural,
    [Description("Yesui(Есүй)-蒙古语（蒙古）")] mn_MN_YesuiNeural,
    [Description("Bataa(Батаа)-蒙古语（蒙古）")] mn_MN_BataaNeural,
    [Description("Aarohi(आरोही)-马拉地语（印度）")] mr_IN_AarohiNeural,
    [Description("Manohar(मनोहर)-马拉地语（印度）")] mr_IN_ManoharNeural,
    ...
    [Description("Nilar(နီလာ)-缅甸语（缅甸）")] my_MM_NilarNeural,
    [Description("Thiha(သီဟ)-缅甸语（缅甸）")] my_MM_ThihaNeural,
    ...
    [Description("Hemkala(हेमकला)-尼泊尔语（尼泊尔）")] ne_NP_HemkalaNeural,
    [Description("Sagar(सागर)-尼泊尔语（尼泊尔）")] ne_NP_SagarNeural,
    ...
    [Description("Subhasini(ସୁଭାସିନୀ)-奥里雅语（印度）")] or_IN_SubhasiniNeural,
    [Description("Sukant(ସୁକାନ୍ତ)-奥里雅语（印度）")] or_IN_SukantNeural,
    [Description("Ojas(ਓਜਸ)-旁遮普语（印度）")] pa_IN_OjasNeural,
    [Description("Vaani(ਵਾਨੀ)-旁遮普语（印度）")] pa_IN_VaaniNeural,
    ...
    [Description("Latifa(لطيفه)-普什图语（阿富汗）")] ps_AF_LatifaNeural,
    [Description("Gul Nawaz( ګل نواز)-普什图语（阿富汗）")] ps_AF_GulNawazNeural,
    [Description("Francisca(Francisca)-葡萄牙语（巴西）")] pt_BR_FranciscaNeural,
    [Description("Antonio(Antônio)-葡萄牙语（巴西）")] pt_BR_AntonioNeural,
    ...
    [Description("Thalita Multilingual(Thalita multilíngue)-葡萄牙语（巴西）")] pt_BR_ThalitaMultilingualNeural,
    ...
    [Description("Thilini(තිළිණි)-僧伽罗语（斯里兰卡）")] si_LK_ThiliniNeural,
    [Description("Sameera(සමීර)-僧伽罗语（斯里兰卡）")] si_LK_SameeraNeural,
    [Description("Viktoria(Viktória)-斯洛伐克语（斯洛伐克）")] sk_SK_ViktoriaNeural,
    [Description("Lukas(Lukáš)-斯洛伐克语（斯洛伐克）")] sk_SK_LukasNeural,
    ...
    [Description("Sophie(Софија)-塞尔维亚语（西里尔字母，塞尔维亚）")] sr_RS_SophieNeural,
    [Description("Nicholas(Никола)-塞尔维亚语（西里尔字母，塞尔维亚）")] sr_RS_NicholasNeural,
    ...
    [Description("Pallavi(பல்லவி)-泰米尔语（印度）")] ta_IN_PallaviNeural,
    [Description("Valluvar(வள்ளுவர்)-泰米尔语（印度）")] ta_IN_ValluvarNeural,
    [Description("Saranya(சரண்யா)-泰米尔语（斯里兰卡）")] ta_LK_SaranyaNeural,
    [Description("Kumar(குமார்)-泰米尔语（斯里兰卡）")] ta_LK_KumarNeural,
    [Description("Kani(கனி)-泰米尔语（马来西亚）")] ta_MY_KaniNeural,
    [Description("Surya(சூர்யா)-泰米尔语（马来西亚）")] ta_MY_SuryaNeural,
    [Description("Venba(வெண்பா)-泰米尔语（新加坡）")] ta_SG_VenbaNeural,
    [Description("Anbu(அன்பு)-泰米尔语（新加坡）")] ta_SG_AnbuNeural,
    [Description("Shruti(శ్రుతి)-泰卢固语（印度）")] te_IN_ShrutiNeural,
    [Description("Mohan(మోహన్)-泰卢固语（印度）")] te_IN_MohanNeural,
    [Description("Premwadee(เปรมวดี)-泰语（泰国）")] th_TH_PremwadeeNeural,
    [Description("Niwat(นิวัฒน์)-泰语（泰国）")] th_TH_NiwatNeural,
    [Description("Achara(อัจฉรา)-泰语（泰国）")] th_TH_AcharaNeural,
    [Description("Emel(Emel)-土耳其语（土耳其）")] tr_TR_EmelNeural,
    [Description("Ahmet(Ahmet)-土耳其语（土耳其）")] tr_TR_AhmetNeural,
    [Description("Polina(Поліна)-乌克兰语（乌克兰）")] uk_UA_PolinaNeural,
    [Description("Ostap(Остап)-乌克兰语（乌克兰）")] uk_UA_OstapNeural,
    [Description("Gul(گل)-乌尔都语（印度）")] ur_IN_GulNeural,
    [Description("Salman(سلمان)-乌尔都语（印度）")] ur_IN_SalmanNeural,
    [Description("Uzma(عظمیٰ)-乌尔都语（巴基斯坦）")] ur_PK_UzmaNeural,
    [Description("Asad(اسد)-乌尔都语（巴基斯坦）")] ur_PK_AsadNeural,
    ...
    [Description("HoaiMy(Hoài My)-越南语（越南）")] vi_VN_HoaiMyNeural,
    [Description("NamMinh(Nam Minh)-越南语（越南）")] vi_VN_NamMinhNeural,
