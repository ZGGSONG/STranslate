    ...
    public abstract class GlobalHook
    {
        ...
        public void Start()
        {
            ...
            using (Process process = Process.GetCurrentProcess())
            {
                ...
                _handleToHook = (int)SetWindowsHookExW(_hookType, _hookCallback, CommonUtil.GetModuleHandle(processModule.ModuleName), 0u);
            }
            if (_handleToHook != 0)
            {
                _isStarted = true;
        ...
        protected virtual int HookCallbackProcedure(int nCode, int wParam, IntPtr lParam) => 0;
