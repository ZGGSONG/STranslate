...
namespace STranslate.Updater
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void Window_Loaded(object sender, RoutedEventArgs e) => Check();
        ...
        private async void Download()
        {
            ...
            try
            {
                ...
                using (var response = await httpClient.GetAsync(new Uri(NewVersionZipURL), HttpCompletionOption.ResponseHeadersRead))
