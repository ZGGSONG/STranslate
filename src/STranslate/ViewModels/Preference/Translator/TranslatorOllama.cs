    ...
    public partial class TranslatorOllama : TranslatorBase, ITranslator
    {
        ...
        [
            new UserDefinePrompt(
                "翻译",
                [
                    new Prompt("system", "You are a professional, authentic translation engine. You only return the translated text, without any explanations."),
            ...
            new UserDefinePrompt(
                "润色",
                [
                    new Prompt("system", "You are a text embellisher, you can only embellish the text, never interpret it."),
