...
public partial class TranslatorDeepSeekPage : UserControl
{
    public TranslatorDeepSeekPage(ITranslator vm)
    {
        InitializeComponent();
    ...
    {
        Process.Start(new ProcessStartInfo { FileName = "https://www.deepseek.com/", UseShellExecute = true });
    }
