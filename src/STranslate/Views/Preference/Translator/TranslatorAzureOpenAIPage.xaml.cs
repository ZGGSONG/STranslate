...
public partial class TranslatorAzureOpenAIPage
{
    public TranslatorAzureOpenAIPage(ITranslator vm)
    {
        InitializeComponent();
    ...
    {
        Process.Start(new ProcessStartInfo { FileName = "https://azure.microsoft.com/zh-cn/products/ai-services/openai-service/", UseShellExecute = true });
    }
