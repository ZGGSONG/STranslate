...
public partial class TranslatorQwenMtPage : UserControl
{
    public TranslatorQwenMtPage(ITranslator vm)
    {
        InitializeComponent();
    ...
    {
        Process.Start(new ProcessStartInfo { FileName = "https://help.aliyun.com/zh/model-studio/machine-translation", UseShellExecute = true });
    }
