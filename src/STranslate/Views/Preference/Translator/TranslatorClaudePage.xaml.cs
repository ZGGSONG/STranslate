...
public partial class TranslatorClaudePage : UserControl
{
    public TranslatorClaudePage(ITranslator vm)
    {
        InitializeComponent();
    ...
    {
        Process.Start(new ProcessStartInfo { FileName = "https://www.anthropic.com/", UseShellExecute = true });
    }
