...
{
    public partial class TextChatglmServicesPage : UserControl
    {
        public TextChatglmServicesPage(ITranslator vm)
        {
            InitializeComponent();
        ...
        private void Hyperlink_Click(object sender, RoutedEventArgs e) => Process.Start(new ProcessStartInfo { FileName = "https://open.bigmodel.cn/", UseShellExecute = true });
