...
{
    public partial class TextOllamaServicesPage : UserControl
    {
        public TextOllamaServicesPage(ITranslator vm)
        {
            InitializeComponent();
        ...
        private void Hyperlink_Click(object sender, RoutedEventArgs e) => Process.Start(new ProcessStartInfo { FileName = "https://ollama.com", UseShellExecute = true });
