...
{
    public partial class TextBaiduBceServicesPage : UserControl
    {
        public TextBaiduBceServicesPage(ITranslator vm)
        {
            InitializeComponent();
        ...
        private void Hyperlink_Click(object sender, RoutedEventArgs e) => Process.Start(new ProcessStartInfo { FileName = "https://cloud.baidu.com/doc/WENXINWORKSHOP/index.html", UseShellExecute = true });
