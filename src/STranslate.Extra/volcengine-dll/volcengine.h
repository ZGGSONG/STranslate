...
extern __declspec(dllexport) GoString TestReceive(char* msg);
extern __declspec(dllexport) GoString TestRunturn();

/* Return type for TestMultiReturn */
struct TestMultiReturn_return {
	GoInt r0;
	GoString r1;
};
